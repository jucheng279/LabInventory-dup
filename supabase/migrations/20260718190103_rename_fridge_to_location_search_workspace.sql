-- Drop all 4 overloads of search_workspace
DROP FUNCTION IF EXISTS public.search_workspace(text, text, text, text, text[], text[], text[], text[], text, text, text, text[], text[], text, text, text, text);
DROP FUNCTION IF EXISTS public.search_workspace(text, text, text, text, text[], text[], text[], text[], text, text, text, text[], text[], text, text, text, text, text[], text, text, text);
DROP FUNCTION IF EXISTS public.search_workspace(text, text, text, text, text, text[], text[], text[], text[], text, text[], text[], text, text, text[], text);
DROP FUNCTION IF EXISTS public.search_workspace(text, text, text, text, text, text[], text[], text[], text[], text, text[], text[], text, text, text[], text, uuid);

-- Recreate the active overload (4th, with p_team_member_id) using new table/column names
...
f.id AS location_id, f.name AS location_name, fs.name AS sublocation_name, sp.name AS position_name
FROM inventory_items ii JOIN locations f ON f.id=ii.location_id JOIN item_folders ifo ON ifo.id=ii.folder_id
...
JOIN item_folders ifo ON ifo.id=ii.folder_id JOIN locations f ON f.id=ii.location_id
LEFT JOIN sublocations fs ON fs.id=ii.sublocation_id LEFT JOIN sublocation_positions sp ON sp.id=ii.position_id
