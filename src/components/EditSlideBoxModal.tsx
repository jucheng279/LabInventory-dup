...
interface EditSlideBoxModalProps {
...
const EditSlideBoxModal: React.FC<EditSlideBoxModalProps> = ({ box, onClose, onUpdate, teamMembers, currentTeamMemberId, workspaceOwnerId, workspaceId }) => {
    ...
    <ModalFrame onClose={onClose} allowOverflow>
      <div className="flex-shrink-0 flex items-center justify-between p-5 border-b border-gray-100">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-lg font-semibold text-gray-900">Edit Slide Box</h2>
          </div>
        </div>
        <div className="flex items-center gap-1">
          ...
          {step === 1 ? (
            <div className="flex-1 min-h-0 overflow-y-auto p-5 space-y-4">
              <div>
                <label htmlFor="editSlideBoxName" className="block text-sm font-medium text-gray-700 mb-1">
                  Box Name
                </label>
                <input
                  ref={nameInputRef}
              ...
              <div>
                <label htmlFor="editSlideBoxDescription" className="block text-sm font-medium text-gray-700 mb-1">
                  Description (optional)
                </label>
                <textarea
                  id="editSlideBoxDescription"
                  value={description}
              ...
              <div>
                ...
                <div className="flex items-center gap-3">
                  <div className="flex-1">
                    <label htmlFor="editSlideBoxRows" className="block text-xs text-gray-500 mb-1">
                      Rows
                    </label>
                    <input
                      type="number"
                  ...
                  <div className="flex-1">
                    <label htmlFor="editSlideBoxColumns" className="block text-xs text-gray-500 mb-1">
                      Columns
                    </label>
                    <select
                      id="editSlideBoxColumns"
                      value={columns}
                ...
                {isShrinking && isValidRows() && columns !== '' && (
...
export default EditSlideBoxModal;
