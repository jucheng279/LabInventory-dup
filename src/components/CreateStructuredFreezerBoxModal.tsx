...
interface CreateStructuredFreezerBoxModalProps {
  onClose: () => void;
...
const CreateStructuredFreezerBoxModal: React.FC<CreateStructuredFreezerBoxModalProps> = ({ onClose, onCreate, teamMembers, currentTeamMemberId, workspaceOwnerId }) => {
    ...
    <ModalFrame onClose={onClose} allowOverflow>
      <div className="flex-shrink-0 flex items-center justify-between p-5 border-b border-gray-100">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-lg font-semibold text-gray-900">Create Structured Freezer Box</h2>
          </div>
        </div>
        <div className="flex items-center gap-1">
          ...
          {step === 1 ? (
            <div className="flex-1 min-h-0 overflow-y-auto p-5 space-y-4">
              <div>
                <label htmlFor="sfBoxName" className="block text-sm font-medium text-gray-700 mb-1">
                  Box Name
                </label>
                <input
                  ref={nameInputRef}
              ...
              <div>
                <label htmlFor="sfBoxDescription" className="block text-sm font-medium text-gray-700 mb-1">
              ...
              <div>
                ...
                <div className="flex items-center gap-3">
                  <div className="flex-1">
                    <label htmlFor="sfBoxRows" className="block text-xs text-gray-500 mb-1">
                      Rows
                    </label>
                    <input
                      type="number"
                  ...
                  <div className="flex-1">
                    <label htmlFor="sfBoxColumns" className="block text-xs text-gray-500 mb-1">
                      Columns
                    </label>
                    <input
                      type="number"
            ...
            <div className="flex-1 min-h-0 overflow-y-auto p-5 space-y-4">
              <div>
                ...
                <p className="text-xs text-gray-500 mb-2">
                  Each header becomes a field in every cell's info region.
                </p>
...
export default CreateStructuredFreezerBoxModal;
